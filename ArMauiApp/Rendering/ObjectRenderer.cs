...
namespace HelloAR
{
	public class ObjectRenderer
	{
		...
		{
			// Read the texture.
			var textureBitmap = BitmapFactory.DecodeStream(FileSystem.Current.OpenAppPackageFileAsync(diffuseTextureAssetName).Result);
			...
			// Read the obj file.
			var objInputStream = FileSystem.Current.OpenAppPackageFileAsync(objAssetName).Result;
			...
			int vertexShader = ShaderUtil.LoadGLShader(TAG, context,
					GLES20.GlVertexShader, "object_vertex.shader");
			int fragmentShader = ShaderUtil.LoadGLShader(TAG, context,
				GLES20.GlFragmentShader, "object_fragment.shader");
